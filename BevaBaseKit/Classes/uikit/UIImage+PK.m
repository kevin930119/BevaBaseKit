...
+ (UIImage *)createRoundedRectImage:(UIImage*)image size:(CGSize)size radius:(NSInteger)r {
    ...
    [self _addRoundedRectToPath:context rect:rect ovalWidth:r ovalHeight:r];
...
+ (void)_addRoundedRectToPath:(CGContextRef)context rect:(CGRect)rect ovalWidth:(float)ovalWidth ovalHeight:(float)ovalHeight {
    float fw, fh;
